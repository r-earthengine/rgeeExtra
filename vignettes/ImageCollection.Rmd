...
```{r}
# Load the first 10 images from the 'COPERNICUS/S2_SR' Image Collection.
ic <- ee$ImageCollection("COPERNICUS/S2_SR")[[1:10]]

# Count the number of images in the subset collection.
imagesCount <- length(ic) # Expected output: 10
```
