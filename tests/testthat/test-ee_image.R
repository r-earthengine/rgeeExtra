...
test_that("ee$Image$Extra_matchHistogram", {
  ...
  expect_s3_class(matched, "ee.image.Image")
})
...
test_that("ee$Image$Extra_preprocess", {
  ...
  expect_s3_class(eestr, "ee.image.Image")
})
...
test_that("ee_Image_spectralIndex", {
  ...
  expect_s3_class(s2_indices, "ee.image.Image")
})
...
test_that("ee$Image$Extra_panSharpen", {
  ...
  expect_s3_class(img_sharp, "ee.image.Image")
})
...
test_that("ee$Image$Extra_maskClouds", {
  ...
  expect_s3_class(img, "ee.image.Image")
})
